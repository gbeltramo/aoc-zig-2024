...
star. They figure the Chief Historian must be in one of the first fifty
places they'll look, so in order to save Christmas, you need to help them get
...
empty. Eventually, someone decides that the best place to check first would
